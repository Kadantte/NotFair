...
After crafting each email, save it to the database:
...
If the user approves an email and asks you to send it, use:
...
When the user asks about replies, use the Gmail MCP tools to search for emails from lead addresses. Check inbox for messages from each contact's email domain. If you find replies, report them and update the contact status.
