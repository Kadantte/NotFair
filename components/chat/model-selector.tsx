...
function connectHref(platform: Platform): string {
  return platform === "meta_ads"
    ? "/connect/meta-ads/claude-connector"
    : "/connect/google-ads/claude-connector";
}

export function UseInYourClaudePill({
  platform = "google_ads",
  surface,
}: {
  platform?: Platform;
  ...
  return (
    <Link
      ...
      prefetch
      onClick={() => {
        trackEvent("chat_use_in_claude_clicked", {
          platform,
          surface,
        });
      }}
    ...
    >
      <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-sm bg-[#D97757]">
        <svg viewBox="0 0 24 24" fill="currentColor" className="h-2.5 w-2.5 text-white" aria-hidden="true">
