...
**Use when:** user signed up, connected their account, but you have no signal they've actually used NotFair (no MCP tool calls, no engagement). The goal is to get them on a 20-min free setup call so Tong can show them Codex + NotFair.
...
Hope this is useful either way. If you want, I can show you how to fix it inside Codex with the NotFair plugin in a few minutes.
...
NotFair isn't an agency — it turns Codex into your ads manager, so you can ask it to find your weakest keywords and rewrite them on the spot.
...
Quick note on how NotFair works — we're not a traditional agency. We turn Codex into your Google Ads manager. With a Codex subscription, it can audit your account, set up conversions, manage campaigns, and more. NotFair itself is free for most users, and based on your current setup, the free tier should cover you easily.
...
NotFair turns Codex into your ads manager, so you can pull stuff like this on demand.
...
- Explain NotFair's value prop briefly — "not an agency, turns Codex into your ads manager"
...
**Better pattern:**
> Share the finding in the email. Then end with something like "Worth a look?" or "If you want, I can walk through how I'd fix this in Codex — otherwise, hope this is useful either way."
...
**The Mode A goal: book a free setup call.** For cold users, the point of outreach is to get them on a quick call where Tong shows them how to use Codex + NotFair so they can find issues and have AI fix them on their own. The audit finding in the email is the hook — the call is the conversion. Make the offer concrete, free, and low-commitment.
...
- "Happy to hop on a quick call and get you set up — I'll show you how to use Codex + NotFair to find stuff like this and have AI fix it for you. Free, takes about 20 min: https://cal.com/tong-chen-uuovdl/30min"
- "If you want, I can walk you through it on a quick free setup call — I'll show you how to use Codex to find issues like this and fix them with AI. https://cal.com/tong-chen-uuovdl/30min"
- "Want me to show you how? I do free 20-min setup calls — you'll leave knowing how to spot stuff like this and have Codex fix it for you. https://cal.com/tong-chen-uuovdl/30min"
