...
1. `AGENTS.md` — product purpose, audience, analytics tool, database
...
Identify the source from `AGENTS.md` (Mixpanel, PostHog, Statsig, Amplitude, Supabase, etc.) and consult the matching reference file under `references/` for auth and query patterns. Default windows: last 7d for recent activity, last 30d for context. Always compare to a prior equivalent period (same day-of-week — B2B weekend traffic is naturally 30–60% lower).
...
python3 .Codex/skills/analyze/scripts/generate_report.py \
