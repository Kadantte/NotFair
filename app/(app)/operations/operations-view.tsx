...
// Server actions that call `redirect()` reject the awaited promise with an
// error whose `digest` starts with "NEXT_REDIRECT". Re-throw it so Next.js can
// finish the navigation; swallowing it into setError() leaves the user
// stranded on a broken page with a generic error message.
