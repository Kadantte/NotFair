...
export const metadata = buildMetadata({
  ...
  path: "/google-ads-claude-connector",
  keywords: [
    ...
    step: [
      {
        ...
        url: new URL("/google-ads-claude-connector#step-1", SITE_URL).toString(),
      },
      {
        "@type": "HowToStep",
        position: 2,
        ...
        url: new URL("/google-ads-claude-connector#step-2", SITE_URL).toString(),
      },
      {
        "@type": "HowToStep",
        position: 3,
        ...
        url: new URL("/google-ads-claude-connector#step-3", SITE_URL).toString(),
      },
      {
        "@type": "HowToStep",
        position: 4,
        ...
        url: new URL("/google-ads-claude-connector#step-4", SITE_URL).toString(),
      },
      {
        "@type": "HowToStep",
        position: 5,
        ...
        url: new URL("/google-ads-claude-connector#step-5", SITE_URL).toString(),
      },
    ],
  },
  {
    ...
    url: new URL("/google-ads-claude-connector", SITE_URL).toString(),
    featureList: [
