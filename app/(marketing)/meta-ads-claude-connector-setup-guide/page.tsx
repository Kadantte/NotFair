  ...
  buildFaqJsonLd(faqItems),
  {
    ...
    step: [
      ...
      },
      {
        "@type": "HowToStep",
        position: 3,
        name: "Pick which Meta ad accounts NotFair can manage",
        text: "After Facebook OAuth, NotFair shows every ad account your Meta identity can access. Check the accounts you want exposed to Claude and save — you can change this curated subset later.",
        url: new URL("/meta-ads-claude-connector-setup-guide#step-3", SITE_URL).toString(),
      },
      {
        "@type": "HowToStep",
        position: 4,
        name: "Enable NotFair-MetaAds in a chat",
        text: "Open a new Claude chat, click the + button, go to Connectors, and toggle NotFair-MetaAds on.",
        url: new URL("/meta-ads-claude-connector-setup-guide#step-4", SITE_URL).toString(),
      },
      {
        "@type": "HowToStep",
        position: 5,
        name: "Ask Claude about your Meta ads",
        text: "Try a prompt like 'List my top-spending Meta campaigns over the last 30 days and flag any with rising CPM.' Claude calls the NotFair Meta tools and answers with live data.",
        url: new URL("/meta-ads-claude-connector-setup-guide#step-5", SITE_URL).toString(),
      },
    ],
  },
  {
