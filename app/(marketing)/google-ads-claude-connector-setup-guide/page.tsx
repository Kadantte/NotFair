  ...
  buildFaqJsonLd(faqItems),
  {
    ...
    step: [
      ...
      },
      {
        ...
        text: "Open a new Claude chat and try a prompt like 'Audit my connected Google Ads account and tell me the 3 biggest optimization opportunities.' Claude calls NotFair tools and answers with live data.",
