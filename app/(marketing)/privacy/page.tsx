    ...
    return (
        <div className="container mx-auto max-w-3xl px-6 py-12 md:py-24 text-zinc-300">
            ...
            <section className="space-y-4 mb-8">
                ...
                <p>
                    If you want us to delete your stored Google connection data, contact us at <a href={`mailto:${SUPPORT_EMAIL}`} className="text-blue-400 hover:underline">{SUPPORT_EMAIL}</a>. You can also revoke NotFair&apos;s access at any time from your Google account permissions settings.
                </p>
            </section>
            ...
            <section className="space-y-4 mb-8">
                ...
                <p>
                    If you have any questions about this Privacy Policy, please contact us at: <a href={`mailto:${SUPPORT_EMAIL}`} className="text-blue-400 hover:underline">{SUPPORT_EMAIL}</a>
                </p>
            </section>
        </div>
    );
