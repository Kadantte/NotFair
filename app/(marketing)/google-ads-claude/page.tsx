...
export const metadata = buildMetadata({
  title: "Google Ads Claude MCP Server | AdsAgent",
  description:
    "Connect Google Ads to Claude in 2 minutes with AdsAgent's MCP server. Claude gets live access to campaigns, spend, keywords, and ad copy. Free audit included.",
...
const jsonLd = [
  buildFaqJsonLd(faqItems),
  {
    ...
    operatingSystem: "Web",
    description:
      "AdsAgent is a Google Ads MCP server for Claude. Connect your Google Ads account to Claude Desktop, Claude Code, or Claude Cowork and manage campaigns through natural conversation.",
    offers: {
      "@type": "Offer",
      price: "0",
      priceCurrency: "USD",
