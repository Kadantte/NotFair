...
- **Known hallucinated fields:** there is no \`metrics.average_cpc_micros\`, \`metrics.conversion_rate\`, or \`asset.sitelink_asset.final_urls\`. Use \`metrics.average_cpc\`; calculate conversion rate from \`metrics.conversions / metrics.clicks\`; call \`getResourceMetadata('asset')\` before selecting asset URL fields.
