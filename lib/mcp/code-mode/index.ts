...
- **Known hallucinated fields:** there is no \`metrics.average_cpc_micros\`, \`metrics.cost_per_conversion_micros\`, \`metrics.impression_share\`, \`metrics.conversion_rate\`, or \`asset.sitelink_asset.final_urls\`. Use \`metrics.average_cpc\`; use \`metrics.cost_per_conversion\`; for Search campaigns use \`metrics.search_impression_share\`; calculate conversion rate from \`metrics.conversions / metrics.clicks\`; call \`getResourceMetadata('asset')\` before selecting asset URL fields.
